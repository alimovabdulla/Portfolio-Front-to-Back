    ...
    public partial class FirstCreated : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AboutMeText", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_latestWorksText", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Language3 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Prosent1 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Prosent2 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Prosent3 = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_lgProsents", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NameSurname", x => x.Id);
                });
